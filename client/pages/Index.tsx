...
export default function Index() {
  ...
  const [chatMessages, setChatMessages] = useState<
    Array<{ id: string; text: string; sender: "user" | "ai"; timestamp: Date }>
  >([]);
      ...
      <div className="flex-1 flex gap-4 sm:gap-6 px-4 sm:px-6 pb-4 sm:pb-6 min-h-0">
        ...
        <div className="flex-1 min-h-0">
          <div className="glass-dark rounded-3xl h-full py-6 pr-6 pl-6 flex items-center justify-center relative">
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-br ${moodColors[currentMood]} rounded-3xl transition-all duration-1000`}
            />
            ...
            <div className="w-full h-full rounded-2xl flex items-center justify-center border border-white/5 relative overflow-hidden z-10">
              <div className="text-center">
                <div
                  className={`w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden mx-auto mb-4 border-4 border-white/20 transition-all duration-500 ${
                    currentExpression === "nod"
                      ? "animate-bounce"
